...
public class MainActivity extends AppCompatActivity {
    ...
    Button btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btnAdd, btnSub,
            btnMul, btnDiv, btnEqu, btnDel, btnDot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMul = (Button) findViewById(R.id.mltply);
        btnDiv = (Button) findViewById(R.id.divied);
        btnDel = (Button) findViewById(R.id.cc);
        btnEqu = (Button) findViewById(R.id.eq);

        edittext1 = (TextView) findViewById(R.id.result);
